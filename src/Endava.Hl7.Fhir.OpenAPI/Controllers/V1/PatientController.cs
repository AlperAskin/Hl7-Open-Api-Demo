...
using Endava.Hl7.Fhir.Common.Contracts.CassandraDbService;
using Cassandra.Mapping;
using Cassandra;
using CsvHelper.TypeConversion;
using Cassandra.Mapping.TypeConversion;
using TypeConverter = Cassandra.Mapping.TypeConversion.TypeConverter;
...
namespace Endava.Hl7.Fhir.OpenAPI.Controllers.V1
{
    ...
    public class PatientController : BaseController<PatientController>
    {
        ...
        private readonly CassandraDbService _cassandraDbService;
        ...
        public PatientController(IFhirService fhirService, IPatientService patientService,
            ...
            IValidator<IList<PatientCsv>> patientsCsvValidator,CassandraDbService cassandraDbService)
        {
            ...
            _cassandraDbService = cassandraDbService;            
        ...
        [HttpGet("GetAllPatientCas")]
        public async Task<IEnumerable<Patient>> GetPatients()
        {
            var patients = await _cassandraDbService.Mapper.FetchAsync<Patient>("SELECT * FROM Patient_Data");
            return patients;
        }
    }
}
